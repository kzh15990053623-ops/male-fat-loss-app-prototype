  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "server/api.mjs": { statements: 90, branches: 85, functions: 90, lines: 95 },
        "server/http.mjs": { statements: 100, branches: 100, functions: 100, lines: 100 },
        "server/nutrition.mjs": { statements: 90, branches: 75, functions: 90, lines: 90 },
        "server/rate-limit.mjs": { statements: 95, branches: 90, functions: 100, lines: 95 },
      },
    },
  },
});
